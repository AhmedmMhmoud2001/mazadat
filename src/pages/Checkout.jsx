  ...
  return (
    <div className="bg-[#F5F2EB] min-h-screen pt-32 pb-12">
      <div className="mx-auto max-w-7xl px-4">
        <div className="grid lg:grid-cols-[1fr_800px] gap-8">
            ...
            <div className="bg-[#F5F2EB] rounded-lg p-5 shadow-[0px_10px_50px_0px_rgba(0,0,0,0.1)] space-y-6">
              ...
              <div className="flex gap-3 justify-end">
                <button
                  ...
                  className={`px-6 py-2 rounded-lg text-[20px] font-normal transition-all ${paymentMethod === "bank"
                ...
                <button
                  ...
                  className={`px-6 py-2 rounded-lg text-[20px] font-bold transition-all ${paymentMethod === "card"
                    ? "bg-[#1C1C28] text-[#F5F2EB]"
                    : "text-[#1C1C28] hover:bg-gray-100"
                    }`}
                >
