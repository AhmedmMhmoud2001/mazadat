  ...
  return (
    <div className="bg-[#F5F2EB] min-h-screen pt-32 pb-12">
      <div className="mx-auto max-w-7xl px-4 space-y-4">
        ...
        <div className="bg-[#FAF9F5] rounded-lg shadow-[0px_10px_50px_0px_rgba(0,0,0,0.1)] p-5 flex items-center justify-between">
        ...
        <div className="grid lg:grid-cols-[561px_1fr] gap-4">
          ...
          <div className="space-y-4 order-2 lg:order-1">
            ...
            {/* Seller Info */}
            <Link to="/dashboard" className="bg-[#F5F2EB] rounded-lg shadow-[0px_10px_50px_0px_rgba(0,0,0,0.1)] p-3 flex items-center justify-end gap-3 h-[103px] hover:shadow-xl transition-shadow cursor-pointer">
        ...
        <div className="bg-[#F5F2EB] rounded-lg shadow-[0px_10px_50px_0px_rgba(0,0,0,0.1)] p-5 space-y-4">
          {bidders.map((bidder, index) => (
            ...
            >
              ...
              <div className="flex items-center justify-end gap-1 text-[#9E7731]">
